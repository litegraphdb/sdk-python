...
def enumerate_with_query_user():
    users = litegraph.User.enumerate_with_query(
...
def retrieve_multiple_user():
    users = litegraph.User.retrieve_many(
        guids=[
...
def update_user():
    user = litegraph.User.update(
        guid="00000000-0000-0000-0000-000000000000", first_name="Test", last_name="User"
    )
    print(user)
