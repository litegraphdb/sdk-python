...
def retrieve_many_node():
    nodes = litegraph.Node.retrieve_many(
        guids=[
            "14ffe58e-6488-4001-bada-6886bcc272ba",
            "adfb3587-a6c7-43fb-95a7-b6fb1d2d1317",
        ],
        graph_guid="1cbb2bc5-a990-49a8-9975-e0b1c34d1011",
    )
    print(nodes)
...
def create_multiple_node():
    nodes = litegraph.Node.create_multiple(
        [
            {"name": "Active Directory", "data": {"type": "service"}},
            {"name": "Website", "data": {"type": "service"}},
        ]
    )
    print(nodes)
...
def update_node():
    node = litegraph.Node.update(
        guid="71eedd9e-3aa9-4e6d-a6ce-299e10fb23ef", name="Test Node Updated"
    )
    print(node)
...
def retrieve_first_node():
    node = litegraph.Node.retrieve_first(
        graph_guid="1cbb2bc5-a990-49a8-9975-e0b1c34d1011"
    )
    print(node)
...
def delete_multiple_node():
    litegraph.Node.delete_multiple(
        guid=[
            "a3f25f44-1f88-462c-84bb-df143a73ce69",
            "c674315b-8a1f-4dc4-a6a7-a598379b7918",
        ]
    )
    print("Nodes deleted")
