...
def retrieve_many_edge():
    edges = litegraph.Edge.retrieve_many(graph_guid="1cbb2bc5-a990-49a8-9975-e0b1c34d1011",guids=["e73bbd3f-2637-4ae3-86a0-7d09f4d76028","e9e90c37-74cd-4a77-9c1f-96167e2bb3f9"])
    print(edges)
...
def update_edge():
    edge = litegraph.Edge.update(guid="e73bbd3f-2637-4ae3-86a0-7d09f4d76028",name="Test Edge Updated",cost=2)
    print(edge)
...
def delete_multiple_edge():
    litegraph.Edge.delete_multiple(guid=["c818e91d-b414-4bb6-b666-03d37790b45f","d3aa9a3f-81d7-4efc-a3bb-a806e722c3b8"])
    print("Edges deleted")
...
def retrieve_first_edge():
    graph = litegraph.Edge.retrieve_first(ordering="CreatedDescending",graph_guid="c940d490-6693-4237-bb08-635890c03bcb")
    print(graph)
