...
def create_label():
    label = litegraph.Label.create(graph_guid="00000000-0000-0000-0000-000000000000",label="Test Label")
    print(label)
...
def retrieve_multiple_label():
    labels = litegraph.Label.retrieve_many(guids=["00000000-0000-0000-0000-000000000000","d559b6e5-c6d0-4897-a9d7-4a199fb887da"])
    print(labels)
...
def update_label():
    label = litegraph.Label.update(guid="00000000-0000-0000-0000-000000000000",label="Updated Label")
    print(label)
