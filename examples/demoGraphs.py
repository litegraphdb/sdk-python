...
def retrieve_multiple_graph():
    graphs = litegraph.Graph.retrieve_many(["ed784972-8e8d-4df7-a104-ff7e23338c80","4072ce04-94ec-48c0-a714-79a484e891a0"])
    print(graphs)

# retrieve_multiple_graph()

def update_graph():
    graph = litegraph.Graph.update(guid="33773395-d573-4ea1-af25-a7d19bb37b1a",name="Test Graph Updated",labels=["test"],tags={"Foo": "Bar"},data={"Key": "Value"},vectors=[{"Vectors":[0.1, 0.2, 0.3],"Content":"Test Content","GraphGUID":"00000000-0000-0000-0000-000000000000","Dimensionality":3,"Model":"all-MiniLM-L6-v2"}])
    print(graph)

# update_graph()

def delete_graph():
    litegraph.Graph.delete(resource_id="33773395-d573-4ea1-af25-a7d19bb37b1a",force=True)
    print("Graph deleted")
...
def retrieve_statistics():
    statistics = litegraph.Graph.retrieve_statistics(graph_guid="33773395-d573-4ea1-af25-a7d19bb37b1a")
    print(statistics)
...
def search_graph():
    graphs = litegraph.Graph.search(expr=litegraph.ExprModel(Left="Name",Operator="Equals",Right="Test"))
    print(graphs)
...
def delete_graph_force():
    litegraph.Graph.delete(resource_id="dd198ef9-6de0-4716-bd58-008fb989480d",force=True)
    print("Graph deleted")
