...
def get_edges_from_node():
    edges = litegraph.RouteNodes.get_edges_from(
...
def get_edges_to_node():
    edges = litegraph.RouteNodes.get_edges_to(
        graph_guid="1cbb2bc5-a990-49a8-9975-e0b1c34d1011",
        node_guid="00000000-0000-0000-0000-000000000000",
    )
    print(edges)
...
def get_edges_between_nodes():
    edges = litegraph.RouteEdges.between(
        graph_guid="1cbb2bc5-a990-49a8-9975-e0b1c34d1011",
        from_node_guid="00000000-0000-0000-0000-000000000000",
        to_node_guid="00000000-0000-0000-0000-000000000001",
    )
    print(edges)
